...
func StartCocoDeployment(namespace string, image string, pullPolicy string, replicas int, dbPort int, dbName string) error {
	deploy := getCocoDeployment(namespace, image, pullPolicy, int32(replicas), dbPort, dbName)
