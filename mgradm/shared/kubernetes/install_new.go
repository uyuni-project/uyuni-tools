...
func Reconcile(flags *KubernetesServerFlags, fqdn string) error {
	...
	if err := shared_kubernetes.WaitForRunningDeployment(namespace, ServerDeployName); err != nil {
		return err
	}
