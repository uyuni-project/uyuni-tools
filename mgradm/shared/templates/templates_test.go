...
`,
		...
		},
		{
			...
			template: PodmanServiceEnvironmentTemplateData{
				...
				Debug:     false,
				Org:       "Example.com",
				Admin:     &apiTypes.User{FirstName: "Test", LastName: "Admin", Email: "adminuser@example.com"},
				HasMirror: false,
			},
			expected: `# uyuni-server environment, generated by mgradm
TZ=GMT
UYUNI_HOSTNAME=uyuni-server.example.com
MANAGER_ADMIN_EMAIL=adminuser@example.com
...
REPORT_DB_PORT=5432
ORG_NAME=My Example.com
ADMIN_FIRST_NAME=Test
ADMIN_LAST_NAME=Admin`,
		},
		{
			name: "ServerEnvironmentDataMirror",
			template: PodmanServiceEnvironmentTemplateData{
				TZ:        "Europe/Berlin",
				HasMirror: true,
			},
