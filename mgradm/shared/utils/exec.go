...
func GeneratePgsqlVersionUpgradeScript(scriptDir string, oldPgVersion string, newPgVersion string) (string, error) {
...
func SanityCheck(
	...
	if runningValues != nil {
		...
		if isUyuni {
			current_uyuni_release := runningValues.UyuniRelease
			...
			current_suse_manager_release := runningValues.SuseManagerRelease
