...
func init() {
  ...
  //TODO argument should be set somewhere else
	...
	setFromArgument(startCmd, &image.namedRepository, "namespace", "registry.opensuse.org/home/mbussolotto/branches/systemsmanagement/uyuni/master/containers/uyuni/server", "Namespace Image", true)
	...
	setFromArgument(migrateCmd, &image.namedRepository, "image", "registry.opensuse.org/home/mbussolotto/branches/systemsmanagement/uyuni/master/containers/uyuni/server", "Image", true)
