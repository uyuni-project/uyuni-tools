...
func DeleteChannels(cnxDetails *api.ConnectionDetails, $param.getFlagName() $param.getType()) (*types.#return_int_success(), error) {
	...
	if err != nil {
		return nil, fmt.Errorf("failed to execute deleteChannels: %s", err)
	}
