...
func ListSubscribableChildChannels(cnxDetails *api.ConnectionDetails, Sid int) (*types.#return_array_begin()
	...
	if err != nil {
		return nil, fmt.Errorf("failed to execute listSubscribableChildChannels: %s", err)
	}
